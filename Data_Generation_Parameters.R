...
"
    ...
    Conditions:
      ...
      3) If the data is supposed to follow a specific distribution, the
         ...
         There is one exception, and that is the 'islog10' argument, which
         indicates if this follows the log distribution and as a final step
         x=10^argument.
      3b) The argument 'n' should NOT be given
      3c) A custom random distribution can be given. However, the first
